 ...
 */
final class Version20250117093854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // $this->addSql('CREATE TABLE carts (id INT AUTO_INCREMENT NOT NULL, quantity_cart INT NOT NULL, owner_cart_id INT DEFAULT NULL, INDEX IDX_4E004AAC96A34B60 (owner_cart_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        // $this->addSql('CREATE TABLE carts_product (carts_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_5D58DB0CBCB5C6F5 (carts_id), INDEX IDX_5D58DB0C4584665A (product_id), PRIMARY KEY(carts_id, product_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        // $this->addSql('CREATE TABLE commands (id INT AUTO_INCREMENT NOT NULL, date_command DATETIME NOT NULL, total_price DOUBLE PRECISION NOT NULL, status_cart VARCHAR(32) NOT NULL, command_number VARCHAR(255) NOT NULL, cart_id INT NOT NULL, UNIQUE INDEX UNIQ_9A3E132C1AD5CDBF (cart_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        // // $this->addSql('CREATE TABLE events (id INT AUTO_INCREMENT NOT NULL, name_event VARCHAR(128) NOT NULL, description_event VARCHAR(255) NOT NULL, begin_date_event DATE NOT NULL, end_date_event DATE NOT NULL, business_id_id INT DEFAULT NULL, INDEX IDX_5387574A1A579E8 (business_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        // $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, description VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, business_id INT DEFAULT NULL, INDEX IDX_D34A04ADA89DB457 (business_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        // $this->addSql('ALTER TABLE carts ADD CONSTRAINT FK_4E004AAC96A34B60 FOREIGN KEY (owner_cart_id) REFERENCES user (id)');
        // $this->addSql('ALTER TABLE carts_product ADD CONSTRAINT FK_5D58DB0CBCB5C6F5 FOREIGN KEY (carts_id) REFERENCES carts (id) ON DELETE CASCADE');
        // $this->addSql('ALTER TABLE carts_product ADD CONSTRAINT FK_5D58DB0C4584665A FOREIGN KEY (product_id) REFERENCES product (id) ON DELETE CASCADE');
        // $this->addSql('ALTER TABLE commands ADD CONSTRAINT FK_9A3E132C1AD5CDBF FOREIGN KEY (cart_id) REFERENCES carts (id)');
        // // $this->addSql('ALTER TABLE events ADD CONSTRAINT FK_5387574A1A579E8 FOREIGN KEY (business_id_id) REFERENCES business (id) ON DELETE CASCADE');
        // $this->addSql('ALTER TABLE events ADD CONSTRAINT FK_5387574AA89DB457 FOREIGN KEY (business_id) REFERENCES business (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE events DROP FOREIGN KEY FK_5387574A1A579E8');
